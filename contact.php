    ...
    <div class="breadcrumb-outer pt-10">
        <div class="container">
            <div class="breadcrumb-content d-md-flex align-items-center pt-10" style="margin-bottom: -60px;">
                <h2 style="padding-top:20px;padding-bottom:200px;" class="mb-0">Contact</h2>
...
<!-- BreadCrumb Ends --> 
    <!-- contact starts -->
    <section class="contact-main pt-0 contact1 bg-grey pb-0">        
                        ...
                        <div class="contact-info">
                            ...
                            <div class="info-item d-flex align-items-center bg-white mb-3">
                                ...
                                <div class="info-content pl-4">
                                    <p class="m-0">Shop No. 2, Haji Mahal,53 Mohammed</p>
                                    <p class="m-0">Ali Rd, Mumbai,Maharashtra 400003</p>
                                </div>
                            </div>
                            <div class="info-item d-flex align-items-center bg-white mb-3">
                                <div class="info-icon">
                                ...
                                <div class="info-content pl-4">
                                    <p class="m-0"><a class="dkfgrfh" href="tel:+912266222000"> +912266222000</a></p>
                                    <p class="m-0"><a class="dkfgrfh" href="tel:+919619878850"> +919619878850</a></p>
                                </div>
                            </div>
                            <div class="info-item d-flex align-items-center bg-white mb-3">
                                <div class="info-icon">
                                ...
                                <div class="info-content pl-4">
                                    ...
                                    <p class="m-0"><a class="dkfgrfh" href="mailto:info@awt.co.in"> info@awt.co.in</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div id="contact-form1" class="contact-form">
                            ...
                            <form method="post" action="#" name="contactform" id="contactform">
                                ...
                                <div class="comment-btn text-right mt-1" style="justify-content: center;display: flex;">
                                    <input style="width: 100%;" type="submit" class="nir-btn" id="submit" value="Send Message">
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <div class="map pb-0">
            <div style="width: 100%">
                <iframe height="500" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3773.4959557433126!2d72.833649!3d18.953692!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7ce3c8354c635%3A0x449fba516a275608!2sAtlas%20World%20Travels%20Private%20Limited!5e0!3m2!1sen!2sin!4v1671538792204!5m2!1sen!2sin"></iframe>
                <!-- <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3773.4959557433126!2d72.833649!3d18.953692!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7ce3c8354c635%3A0x449fba516a275608!2sAtlas%20World%20Travels%20Private%20Limited!5e0!3m2!1sen!2sin!4v1671538792204!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> -->
            </div>
        </div>
    </section>
    <!-- contact Ends -->
