    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="index.php" class="nav-link">Home / Package</a>
        </li>
      ...
      <div class="modal fade" id="deleteData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="hajj_package-db.php" method="POST">
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Package
                  </h3>
                  <a href="hajj_package-add.php" class="btn btn-primary btn-sm float-right">Add New Package</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      ?>
                          ...
                          <td><?= ($row['id']); ?></td>
                            ...
                            <td>
                              <a href="hajj_package-edit.php?package_id=<?php echo ($row['id']); ?>" class="btn btn-info btn-sm">Edit</a>
