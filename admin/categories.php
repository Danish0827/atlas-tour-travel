<?php
require('config/myFunctions.php');
session_start();
      ...
      <div class="modal fade" id="addCategories" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="categories-db.php" method="POST">
              <div class="modal-body">
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="4_in_room" onkeyup="if(this.value<0){this.value= this.value * -1}" class="form-control" placeholder="4 in Room Price">
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="">3 in Room Price</label>
                    <input type="number" min=0 name="3_in_room" onkeyup="if(this.value<0){this.value= this.value * -1}" class="form-control" placeholder="3 in Room Price">
                  </div>
                  <div class="col-md-6 mb-3">
                    <label for="">2 in Room Price</label>
                    <input type="number" min=0 name="2_in_room" onkeyup="if(this.value<0){this.value= this.value * -1}" class="form-control" placeholder="2 in Room Price">
                  </div>
                      ...
                      <tbody>
                        ...
                        ?>
                            ...
                            <td><?= $i;?></td>
                              ...
                              <td>
                              <a href="categories-edit.php?category_id=<?php echo ($row['id']); ?>" class="btn btn-info btn-sm w-100 my-2">Edit</a>
