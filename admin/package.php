            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <a href="package-add.php" class="btn btn-primary btn-sm float-right">Add New Package</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      ?>
                          ...
                          <td><?= ($row['id']); ?></td>
                            ...
                            <td>
                              <a href="package-edit.php?package_id=<?php echo ($row['id']); ?>" class="btn btn-info btn-sm">Edit</a>
