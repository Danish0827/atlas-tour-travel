          ...
          <div class="row">
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-info">
                <div class="inner">
                  <?php
                  $dash_query = "Select * from package";
                  $query_run = mysqli_query($con, $dash_query);
          ...
          <div class="row">
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-light">
                <div class="inner">
                  <?php
                  $dash_query = "Select * from hajj_package";
                  $query_run = mysqli_query($con_hajj, $dash_query);
                  if ($category_total = mysqli_num_rows($query_run)) {
                    echo '<h3>' . $category_total . '</h3>';
                  } else {
                    echo '<h3>No</h3>';
                ...
                <a href="hajj_package.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-warning">
                <div class="inner">
                  <?php
                  $posts = "Select * from hajj_categories";
                  $query_run = mysqli_query($con_hajj, $posts);
                  if ($post_total = mysqli_num_rows($query_run)) {
                    echo '<h3>' . $post_total . '</h3>';
                  } else {
                    echo '<h3>No</h3>';
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-dark">
                <div class="inner">
                  <?php
                  $posts = "Select * from hajj_category";
                  $query_run = mysqli_query($con_hajj, $posts);
                  if ($post_total = mysqli_num_rows($query_run)) {
                    echo '<h3>' . $post_total . '</h3>';
                  } else {
                ...
                <a href="hajj_category.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-secondary">
                <div class="inner">
                  <?php
                  $posts = "Select * from hajj_package_detail";
                  $query_run = mysqli_query($con_hajj, $posts);
                  if ($post_total = mysqli_num_rows($query_run)) {
                    echo '<h3>' . $post_total . '</h3>';
                  } else {
                  ...
                  <p>Hajj Package Detail</p>
                </div>
                <div class="icon">
                  <i class="ion ion-stats-bars"></i>
                </div>
                <a href="hajj_package_detail.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
          </div>
        </div>
